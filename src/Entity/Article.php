...
class Article
{
    ...
    #[ORM\Column(length: 255)]
    private ?string $imageFeatured = null;
     ...
     */
    #[ORM\ManyToMany(targetEntity: Media::class, cascade:['persist', 'remove'], inversedBy: 'articles')]
    ...
    public function setImageFeatured(string $imageFeatured): static
    {
